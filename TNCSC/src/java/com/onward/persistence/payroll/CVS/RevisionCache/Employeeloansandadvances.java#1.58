...
/**
 * Employeeloansandadvances generated by hbm2java
 */
public class Employeeloansandadvances  implements java.io.Serializable {
    ...
    public Employeeloansandadvances() {
    }

	
    public Employeeloansandadvances(String id) {
        this.id = id;
    }
    public Employeeloansandadvances(String id, Employeemaster employeemaster, String deductioncode, Date loandate, BigDecimal loanamount, Integer totalinstallment, Integer currentinstallment, BigDecimal installmentamount, BigDecimal firstinstallmentamount, BigDecimal loanbalance, String loantype, String status, String fileno, String regionno, Boolean synchronized_, String accregion, Set employeeloansandadvancesdetailses, Set supplementaryemployeeloansandadvancesdetailses) {
       this.id = id;
