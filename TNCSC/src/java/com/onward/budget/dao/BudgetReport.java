...
public class BudgetReport {
    ...
    private char[] horizontalsign = new char[170];
    private char[] horizontalline = new char[170];
    private char[] equalline = new char[170];
    ...
    public void budgetReportHeader(PrintWriter pw, ReportModel psm) {
        ...
        pw.println();
        lineno++;
        pw.printf("%150s%4s%s%2s%5s%4s%s%2s", "", startyear, "-", endyearsubset, "     ", startyear + 1, "-", nextyearsubset);
        pw.println();
        lineno++;
        pw.print(horizontalline);
        pw.println();
