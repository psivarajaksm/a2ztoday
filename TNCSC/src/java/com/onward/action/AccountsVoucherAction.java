 ...
 * @author root
 */
public class AccountsVoucherAction extends OnwardAction {
    ...
    public Map createBankChallan(String type, String checkBoxValues, String dateofchallan, String bank, String remarks, String periodcode, HttpServletRequest request, HttpServletResponse response) {
        return accountVoucherService.createBankChallan(null, request, response, null, null, type, checkBoxValues, dateofchallan, bank, remarks, periodcode);
    }
    ...
    public Map getIRSReconciledLedgerDetailsExcellWrite(String period, String ledger, String voucherdatefrom, String voucherdateto, HttpServletRequest request, HttpServletResponse response) {
        Map map = new HashMap();
        try {
            String regioncode = (String) request.getSession().getAttribute("regioncode");
            String fileName = "IRS" + regioncode + "VS" + ledger + ".xls";
            ...
            map = accountVoucherService.getIRSReconciledLedgerDetailsExcellWrite(null, request, response, null, null, period, ledger, voucherdatefrom, voucherdateto, filePathwithName);
...
//    public Map getLedgerDetails(String book, String period, String ledger, String voucherdatefrom, String voucherdateto, HttpServletRequest request, HttpServletResponse response) {
//        return accountVoucherService.getLedgerDetails(null, request, response, null, null, book, period, ledger, voucherdatefrom, voucherdateto);
//    }
    ...
    public Map getConsolidatedTrailBalanceDetails(String period, String voucherdatefrom, String voucherdateto, HttpServletRequest request, HttpServletResponse response) {
        return accountVoucherService.getConsolidatedTrailBalanceDetails(null, request, response, null, null, period, voucherdatefrom, voucherdateto);
    }

    public Map getTrailBalanceDetailsByRegion(String period, String voucherdatefrom, String voucherdateto, String selectedRegion, HttpServletRequest request, HttpServletResponse response) {
        return accountVoucherService.getTrailBalanceDetailsByRegion(null, request, response, null, null, period, voucherdatefrom, voucherdateto, selectedRegion);
    }
