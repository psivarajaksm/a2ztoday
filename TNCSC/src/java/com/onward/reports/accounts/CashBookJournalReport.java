...
public class CashBookJournalReport extends OnwardAction {
    ...
    public void Header(AccountsModel am, PrintWriter pw) {
        ...
        pw.printf("%20s%-9s%21s%10s%4s%10s%11s%2s", "          CASH BOOK ", cashbookname, " FOR THE PERIOD FROM ", am.getFromdate(), " To ", am.getTodate(), "   Page No:", pageno);
        pw.println();
        pw.printf("%s", " -----------------------------------------------------------------------------------------------------------");
        pw.println();
        pw.printf("%s", " |    DATE    |   VR.NO   |   CODE   |          JOURNAL DETAILS              |     DEBIT    |    CREDIT    |");
        pw.println();
        pw.printf("%s", " |------------|-----------|----------|---------------------------------------|--------------|--------------|");
        pw.println();
        pageno++;
    ...
    public void GrandTotal(AccountsModel am, String filePath) {
        try {
            ...
            try {
                ...
                pw.printf("%s", " |---------------------------------------------------------------------------------------------------------|");
                pw.println();
                pw.printf("%78s%14s%s%14s%s", " |                                                                  Day Total|", decimalFormat.format(day_payment), line1, decimalFormat.format(day_adjustment), line1);
                pw.println();
                pw.printf("%s", " |=========================================================================================================|");
                pw.println();
                pw.printf("%78s%14s%s%14s%s", " |                                                                Grant Total|", decimalFormat.format(grant_payment), line1, decimalFormat.format(grant_adjustment), line1);
                pw.println();
                pw.printf("%s", " |=========================================================================================================|");
                pw.flush();
                pw.close();
    ...
    public void getPrintWriter(AccountsModel am, String filePath) {
        ...
        try {
            ...
            while (pitr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, am.getAccdate(), line, am.getVoucherno(), line, "", line, Align((String) pmap.getKey(), 37, "CENTER"), line2, "", line1, "", line1);
                pw.println();
                lineno++;
                ...
                while (itr.hasNext()) {
                    ...
                    pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, "", line, "", line, asm.getAccno(), line, Align(asm.getAccname(), 37, "LEFT"), line2, asm.getAmount(), line1, "", line1);
                    pw.println();
            ...
            while (aitr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, am.getAccdate(), line, am.getVoucherno(), line, "", line, Align((String) amap.getKey(), 37, "CENTER"), line2, "", line1, "", line1);
                pw.println();
                lineno++;
                ...
                while (itr.hasNext()) {
                    AccountsSubModel asm = (AccountsSubModel) itr.next();
                    pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, "", line, "", line, asm.getAccno(), line, Align(asm.getAccname(), 37, "LEFT"), line2, "", line1, asm.getAmount(), line1);
                    pw.println();
            ...
            if (am.getPaymentmap().size() > 0) {
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, "", line, "", line, "", line, "", line2, "--------------", line1, "--------------", line1);

                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, "", line, "", line, "", line, "", line2, decimalFormat.format(paymenttotal), line1, decimalFormat.format(adjustmenttotal), line1);
                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%37s%2s%14s%s%14s%s", line, "", line, "", line, "", line, "", line2, "--------------", line1, "--------------", line1);
                pw.println();
            ...
            while (itr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%9s%3s%8s%3s%-37s%2s%14s%s%14s%s", line, "", line, "", line, "", line, str.trim(), line2, "", line1, "", line1);
                pw.println();
                lineno++;
                i++;
            }
            ...
            day_payment += paymenttotal;
            day_adjustment += adjustmenttotal;
            grant_payment += paymenttotal;
