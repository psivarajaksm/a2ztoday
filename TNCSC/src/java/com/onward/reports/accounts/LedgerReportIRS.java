...
public class LedgerReportIRS extends OnwardAction {
    ...
    public void GrandTotal(AccountsModel am, String filePath) {
        try {
            ...
            try {
                ...
                pw.printf("%s", "  |========|===================================|===============|===============|");
                pw.println();
                pw.printf("%3s%8s%s%-5s%-30s%s%15s%s%15s%s", "  |", "", "|", vdateandyear, " Balance", "|", decimalFormat.format(debitbalance), "|", decimalFormat.format(creditbalance), "|");
                pw.println();
                pw.printf("%s", "  |========|===================================|===============|===============|");
                pw.println();
                debittotal = 0;
     ...
     public void monthwisetotal(AccountsModel am, PrintWriter pw) {
        ...
        pw.printf("%s", "  |========|===================================|===============|===============|");
        pw.println();
        debitbalanceamount = debitbalance;
...
//                System.out.println(am.getAccdate() + "   inside !vdate.equals(am.getAccdate().substring(3, 5))  :" + am.getAccdate().substring(3, 5) + "  lineno  : " + lineno);                                
...
//                System.out.println(str.trim()+" - >"+str.length());
    ...
    public void getPrintWriterOLD(AccountsModel am, String filePath) {
        ...
        try {
            ...
            if (!vdate.equals(am.getAccdate().substring(3, 5))) {
//                System.out.println(am.getAccdate() + "   inside !vdate.equals(am.getAccdate().substring(3, 5))  :" + am.getAccdate().substring(3, 5) + "  lineno  : " + lineno);
                monthwisetotal(am, pw);
                vdate = am.getAccdate().substring(3, 5);
                vdateandyear = am.getAccdate().substring(3, 8);
