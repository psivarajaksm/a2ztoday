 ...
 */
public class PurchaseVatExportReport {
    ...
    public boolean GeneratePurchaseVatExportXML(List purchaselist, String filePath) {
        ...
        try {
            ...
            createHeader(wb, row, (short) 0, "Sl.No.");
            sheet.setColumnWidth(0, (short) (1000));

            createHeader(wb, row, (short) 1, "Name_of_seller");
            sheet.setColumnWidth(1, (short) (10000));

            createHeader(wb, row, (short) 2, "Seller_TIN");
            ...
            createHeader(wb, row, (short) 6, "Purchase_Value");
            ...
            while (iterator.hasNext()) {
                ...
                createContent2(wb, row, (short) 4, (String) am.getBillno(), CellStyle.ALIGN_RIGHT);
                sheet.setColumnWidth(4, (short) (3500));
