 ...
 */
public class PaymentRealizationReport {

    public boolean GeneratePurchaseVatExportXML(Map PaymentRealizationmap, String filePath) {
        boolean result = false;
        String region = (String) PaymentRealizationmap.get("regionname");
        ...
        try {
            ...
            createHeader(wb, row, (short) 3, "CHEQUE/DD DATE");
            ...
            List plist = (List) PaymentRealizationmap.get("realizationlist");
            ...
            while (iterator.hasNext()) {
                ...
                createContent(wb, row, (short) 3, am.getChequedate(), CellStyle.ALIGN_RIGHT);
                sheet.setColumnWidth(3, (short) (4500));

                createContent(wb, row, (short) 4, am.getAccdate(), CellStyle.ALIGN_RIGHT);
                sheet.setColumnWidth(4, (short) (4500));
