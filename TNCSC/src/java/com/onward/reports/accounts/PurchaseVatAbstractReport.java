...
public class PurchaseVatAbstractReport extends OnwardAction {
    ...
    public PurchaseVatAbstractReport() {
        for (int i = 0; i < 87; i++) {
            horizontalsign[i] = '~';
        }
        for (int i = 0; i < 87; i++) {
    ...
    public void Header(AccountsModel am, PrintWriter pw) {
        ...
        pw.write(RELEASE);
        pw.println();
        pw.printf("%60s%-8s", "Purchase Vat Abstract For the Month Of :", am.getAccdate());
        pw.println();
