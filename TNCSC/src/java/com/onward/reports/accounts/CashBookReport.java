...
public class CashBookReport extends OnwardAction{
    ...
    public void GrandTotal(AccountsModel am, String filePath) {
        try {
            ...
            try {
                ...
                pw.printf("%s", " |----------------------------------------------------------------------------------------------------------------------------------|");
                pw.println();
                pw.printf("%103s%14s%s%14s%s", " |                                                                              Day Total             |", decimalFormat.format(day_payment), line1, decimalFormat.format(day_adjustment), line1);
                pw.println();
                pw.printf("%s", " |==================================================================================================================================|");
                pw.println();
                pw.printf("%103s%14s%s%14s%s", " |                                                                              Grant Total           |", decimalFormat.format(grant_payment), line1, decimalFormat.format(grant_adjustment), line1);
                pw.println();
                pw.printf("%s", " |==================================================================================================================================|");
                pw.flush();
                pw.close();
    ...
    public void getPrintWriter(AccountsModel am, String filePath) {
        ...
        try {
            ...
            while (pitr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, am.getAccdate(), line, (am.getVoucherno() == null) ? "" : am.getVoucherno(), line, (am.getCompno() == null) ? "" : am.getCompno(), line, "", line, Align((String) pmap.getKey(), 37, "CENTER"), line2, "", line1, "", line1, "", line1);
                pw.println();
                lineno++;
                ...
                while (itr.hasNext()) {
                    ...
                    pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, asm.getAccno(), line, Align(asm.getAccname(), 37, "LEFT"), line2, asm.getAmount(), line1, "", line1, "", line1);
                    pw.println();
            ...
            if (am.getPaymentmap().size() > 0) {
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, "", line2, "--------------", line1, "", line1, "", line1);
                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, "", line2, decimalFormat.format(paymenttotal), line1, "", line1, "", line1);
                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, "", line2, "==============", line1, "", line1, "", line1);
                pw.println();
            ...
            while (aitr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, am.getAccdate(), line, (am.getVoucherno() == null) ? "" : am.getVoucherno(), line, (am.getCompno() == null) ? "" : am.getCompno(), line, "", line, Align((String) amap.getKey(), 37, "CENTER"), line2, "", line1, "", line1, "", line1);
                pw.println();
                lineno++;
            ...
            if (am.getAdjustmentmap().size() > 0) {
                ...
                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, "", line2, decimalFormat.format(adjustmenttotal), line1, "", line1, "", line1);
                pw.println();
                lineno++;
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, "", line2, "==============", line1, "", line1, "", line1);
                pw.println();
            ...
            while (itr.hasNext()) {
                ...
                pw.printf("%3s%10s%3s%6s%3s%10s%3s%8s%3s%-37s%2s%14s%s%14s%s%14s%s", line, "", line, "", line, "", line, "", line, str.trim(), line2, "", line1, (i == 1) ? decimalFormat.format(paymenttotal - adjustmenttotal) : "", line1, (i == 1) ? decimalFormat.format(adjustmenttotal) : "", line1);
                pw.println();
                lineno++;
                i++;
            }
