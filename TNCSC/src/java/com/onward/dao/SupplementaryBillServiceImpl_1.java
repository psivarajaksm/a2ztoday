...
import com.onward.common.PayBillPrinter;
 ...
 * @author root
 */
//public class SupplementaryBillServiceImpl_1 extends OnwardAction implements SupplementaryBillService {
public class SupplementaryBillServiceImpl_1 extends OnwardAction  {
                                ...
                                for (int i = 0; i < empEarList.size(); i++) {
                                    ...
                                    if (empEarTranList.size() > 0) {
                                        ...
                                        if (supplementaryemployeeearningsdetailsObje.getAmount().compareTo(BigDecimal.ZERO) > 0) {
                                            ...
                                            employeeearningstransactionsObj.setAmount(calculateEarningsForGivenDays(session, epfno, supplementarypayrollprocessingdetailsObj.getNooddayscalculated(), supplementarypayrollprocessingdetailsObj.getCalculatedmonth(), supplementarypayrollprocessingdetailsObj.getCalculatedyear(), getEarningsAmount(session, subSalaryStructureId, supplementaryemployeeearningsdetailsObje.getEarningmasterid(), LoggedInRegion)));
                                        }
                                    ...
                                    for (int i = 0; i < empDeduList.size(); i++) {
                                        ...
                                        if (empDeduTranList.size() > 0) {
                                            ...
                                            if (supplementaryemployeedeductiondetailsObje.getAmount().compareTo(BigDecimal.ZERO) > 0) {
                                                ...
                                                employeedeductionstransactionsObj.setAmount(getDeductionAmount(session, subSalaryStructureId, supplementaryemployeedeductiondetailsObje.getDeductionmasterid(), supplementarypayrollprocessingdetailsObj.getNooddayscalculated(), supplementarypayrollprocessingdetailsObj.getCalculatedmonth(), supplementarypayrollprocessingdetailsObj.getCalculatedyear(), LoggedInRegion));
                                            }
...
//                    System.out.println("=====()()()()()===");
    ...
    public BigDecimal getEarningsAmount1(Session session, String subSalaryStructureId, String earningMasterid, String LoggedInRegion) {
    ...
    public BigDecimal getDeductionAmount(Session session, String subSalaryStructureId, String deductionMasterid, int nofodays, int month, int year, String LoggedInRegion) {
        float total = 0;
        float earamt = 0;
        Ccahra ccahraObj;
        Supplementaryemployeeearningsdetails employeeearningsdetailsObj;
            ...
            for (int i = 0; i < ccaHRAList.size(); i++) {
                ...
                if (earCritList.size() > 0) {
                    ...
                    if (employeeearningsdetailsObj.getAmount().floatValue() != 0) {
                        ...
                        total = total + getEarningsAmount1(session, subSalaryStructureId, employeeearningsdetailsObj.getEarningmasterid(), LoggedInRegion).floatValue();
                    }
    ...
    public BigDecimal getDeductionAmountSurrender(Session session, String subSalaryStructureId, String deductionMasterid, int nofodays, String LoggedInRegion) {
        float total = 0;
        float earamt = 0;
        Ccahra ccahraObj;
        Supplementaryemployeeearningsdetails employeeearningsdetailsObj;
    ...
    public BigDecimal getEarningsAmount(Session session, String subSalaryStructureId, String earningMasterid, String LoggedInRegion) {
...
//                        Salarydeductionothers sdoObj = (Salarydeductionothers) obj;
    ...
    @GlobalDBOpenCloseAndUserPrivilages
    //public Map saveLeaveSurrenderBill(Session session, HttpServletRequest request, HttpServletResponse response, String LoggedInRegion, String LoggedInUser, String epfno, String asondate, String surrenderdays, String orderno, String funtype, String surrenderdate) {
    public Map saveLeaveSurrenderBill(Session session, HttpServletRequest request, HttpServletResponse response, String LoggedInRegion, String LoggedInUser, String epfno, String asondate, String surrenderdays, String orderno, String funtype, String surrenderdate, String designationname) {
        System.out.println("EPF No" + epfno + "As on Date" + asondate + "surrenderdays" + surrenderdays + "Order no" + orderno);
        Map resultMap = new HashMap();
        Transaction transaction = null;
        String subSalaryStructureId = "";
        ...
        try {
            ...
            transaction = session.beginTransaction();
            String updateprocessDetails = " UPDATE employeemaster SET eslp='" + postgresDate(surrenderdate) + "' where region='" + LoggedInRegion + "' and  epfno='" + epfno + "'";
...
//                    transaction.commit();
                ...
                transaction.commit();
//                transaction = session.beginTransaction();
//                session.createSQLQuery("UPDATE supplementaryemployeedeductionstransactions  SET cancelled  = true WHERE supplementarypayrollprocessingdetailsid='" + supplementarypayrollprocessingdetailsObj.getId() + "'").executeUpdate();
//                transaction.commit();
                    ...
                    for (int i = 0; i < empEarList.size(); i++) {
                        ...
                        if (empEarTranList.size() > 0) {
                            ...
                            if (supplementaryemployeeearningsdetailsObje.getAmount().compareTo(BigDecimal.ZERO) > 0) {
                                ...
                                employeeearningstransactionsObj.setAmount(calculateEarningsForGivenDays30(Integer.parseInt(surrenderdays), getEarningsAmount(session, subSalaryStructureId, supplementaryemployeeearningsdetailsObje.getEarningmasterid(), LoggedInRegion)));
                            }
                            employeeearningstransactionsObj.setCancelled(Boolean.FALSE);
                            employeeearningstransactionsObj.setCreatedby(LoggedInUser);
                            employeeearningstransactionsObj.setCreateddate(getCurrentDate());
    ...
    @GlobalDBOpenCloseAndUserPrivilages
    //public Map saveIncrementArrearBill(Session session, HttpServletRequest request, HttpServletResponse response, String LoggedInRegion, String LoggedInUser, String epfno, String asondate, String orderno, String startmonth, String startyear, String endmonth, String endyear, String earningCode, String earningAmount) {
...
//                    employeedeductionstransactionsObj.setAmount(getEPFAmount(session, subtotal[p]));
                            employeedeductionstransactionsObj.setAmount(getEPFAmount(session, totalearpaid));
                            employeedeductionstransactionsObj.setCreatedby(LoggedInUser);
                            employeedeductionstransactionsObj.setCreateddate(getCurrentDate());
                            employeedeductionstransactionsObj.setCancelled(Boolean.FALSE);
                            transaction = session.beginTransaction();
...
//            PayBillPrinter pbp = new PayBillPrinter();
            ...
            if (epfno == null || epfno.length() == 0) {
                ...
                EmployeeDetails_Query = "select spb.employeeprovidentfundnumber,em.employeename,em.dateofbirth,  em.dateofappoinment,em.dateofconfirmation,"
                        + "rm.regionname, sn.sectionname,dm.designation,em.employeecode,spb.id, dm.payscalecode, em.banksbaccount, em.pancardno from supplementatypaybill spb "
                ...
                EmployeeDetails_Query = "select spb.employeeprovidentfundnumber,em.employeename,em.dateofbirth,  em.dateofappoinment,"
                        + "em.dateofconfirmation, rm.regionname, sn.sectionname,dm.designation,em.employeecode,spb.id, dm.payscalecode, em.banksbaccount, em.pancardno from supplementatypaybill spb "
                        + "left join  employeemaster em on spb.employeeprovidentfundnumber = em.epfno "
                        + "left join  sectionmaster sn on spb.section=sn.id "
                        + "left join  regionmaster rm on spb.accregion=rm.id "
                        + "left join  designationmaster dm on spb.designation=dm.designationcode "
...
//        PrintIncrementArrearDetails(session, request, response, LoggedInRegion, LoggedInUser, epfno, asondate);
    ...
    public Map PrintIncrementArrearDetails(Session session, HttpServletRequest request, HttpServletResponse response, String LoggedInRegion, String LoggedInUser, String epfno, String asondate, String filePathwithName) {
        ...
        String[] earcodes = {"E01", "E04", "E06", "E07", "E25"};
        String subvec = "";
        int slipno = 1;
        try {
...
//            strbuild.append("and spb.id='R011699'");
            ...
            for (ListIterator lit = EmployeeQuery.list().listIterator(); lit.hasNext();) {
                ...
                sb.append("where supplementatypaybillid = '" + supplementarypaybillid + "' and cancelled is false  order by id");
...
//            EMPLOYEEQUERY = "select spb.id,spb.employeeprovidentfundnumber,sm.sectionname,rm.regionname,em.employeename,dm.designation,spb.paymentmode,em.banksbaccount "
//                    + "from supplementatypaybill spb "
//                    + "left join employeemaster em on em.epfno=spb.employeeprovidentfundnumber "
//                    + "left join regionmaster rm on rm.id=spb.accregion "
//                    + "left join designationmaster dm on dm.designationcode=spb.designation "
//                    + "left join sectionmaster sm on sm.id=spb.section "
//                    + "where spb.date='" + postgresDate(asondate) + "' and spb.type='DAARREAR' and spb.cancelled is false and "
//                    + "spb.accregion='" + LoggedInRegion + "' and spb.paymentmode='" + paymentmode + "' order by spb.section,spb.designation";
...
//        System.out.println("Employee_Query.list().size()" + Employee_Query.list().size());
    ...
    @GlobalDBOpenCloseAndUserPrivilages
    public Map EmployeeSupplementaryDAAbstractPrintOut(Session session, HttpServletRequest request, HttpServletResponse response, String LoggedInRegion, String LoggedInUser, String dabatch, String paymentmode, String filePathwithName) {
...
//            System.out.println("SECTIONQUERY = " + SECTIONQUERY);
            ...
            for (ListIterator its = section_Query.list().listIterator(); its.hasNext();) {
                ...
                StringBuilder sbdeduction = new StringBuilder();

                sbearings.append("select sum(amount) earningamount from supplementaryemployeeearningstransactions  seet ");
                sbearings.append("left join supplementarypayrollprocessingdetails sppd on sppd.id=seet.supplementarypayrollprocessingdetailsid ");
                sbearings.append("left join supplementatypaybill spb on spb.id=sppd.supplementatypaybillid ");
                sbearings.append("where spb.accregion = '" + LoggedInRegion + "' ");
                sbearings.append("and spb.dabatch='" + dabatch + "' ");
                sbearings.append("and spb.cancelled is false ");
                sbearings.append("and sppd.cancelled is false ");
                sbearings.append("and seet.cancelled is false ");
                sbearings.append("and spb.employeeprovidentfundnumber not in (select epfno from stoppayrolldetails where (reasoncode='RETIRED' or reasoncode='TRANSFERRED') and accregion='" + LoggedInRegion + "') ");
                if (paymentmode.length() > 0) {
                    sbearings.append("and spb.paymentmode='" + paymentmode + "' ");
                }
                sbearings.append("and spb.section='" + sectioncode + "' ");
                sbearings.append("and seet.earningmasterid='E04'");

                sbdeduction.append("select sum(amount) deductionamount from supplementaryemployeedeductionstransactions  sedt ");
                sbdeduction.append("left join supplementarypayrollprocessingdetails sppd on sppd.id=sedt.supplementarypayrollprocessingdetailsid ");
                sbdeduction.append("left join supplementatypaybill spb on spb.id=sppd.supplementatypaybillid ");
                sbdeduction.append("where spb.accregion = '" + LoggedInRegion + "' ");
                sbdeduction.append("and spb.dabatch='" + dabatch + "' ");
                sbdeduction.append("and spb.cancelled is false ");
                sbdeduction.append("and sppd.cancelled is false ");
                sbdeduction.append("and sedt.cancelled is false ");
                sbdeduction.append("and spb.employeeprovidentfundnumber not in (select epfno from stoppayrolldetails where (reasoncode='RETIRED' or reasoncode='TRANSFERRED') and accregion='" + LoggedInRegion + "') ");
                if (paymentmode.length() > 0) {
                    sbdeduction.append("and spb.paymentmode='" + paymentmode + "' ");
                }
                sbdeduction.append("and spb.section='" + sectioncode + "' ");
                sbdeduction.append("and sedt.deductionmasterid='D02'");

                SQLQuery earning_Query = session.createSQLQuery(sbearings.toString());

                SQLQuery deduction_Query = session.createSQLQuery(sbdeduction.toString());

//                System.out.println("sbearings.toString() = " + sbearings.toString());
//                System.out.println("sbdeduction.toString() = " + sbdeduction.toString());
