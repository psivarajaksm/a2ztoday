...
<html>
            ...
            <div id="content">
                ...
                <table width="70%" align="center" class="tableBorder2"  border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="lightrow">
                        ...
                        <td width="1%" class="mandatory">*</td>
                        <td width="20%" colspan="4" class="textfieldalign" >
                            <input type="text" class="textbox" name="fpfno" id="fpfno" readonly="true">
                        </td>
                    </tr>
                    <tr class="darkrow">
                        ...
                        <td width="1%" class="mandatory">*</td>
                        <td width="20%" colspan="4" class="textfieldalign" >
                            <input type="text" class="textbox" name="fathername" id="fathername" readonly="true">
                        </td>
                    </tr>
                    <tr class="lightrow">
                    ...
                    <tr class="lightrow">                        
                        <td width="29%" class="textalign">Present Cadre Join Date</td>
                        <td width="1%" class="mandatory"></td>
                        <td width="20%" colspan="4" nowrap class="textfieldalign" >
                            <!--                            <input type="text" class="textbox" name="positiondate" id="positiondate">-->
                            <input type="text" class="datetextbox" name="positiondate" id="positiondate" maxlength="10" onkeyup="formatDate(this);" onblur="isValidDate(this); minorValidateDate(this);">&nbsp;
                            <select class="combobox" name="positiontime" style="width:60px;" id="positiontime" class="textfieldalign" >
                                <option value="0">Select</option>
                                <option value="am">AM</option>
                                <option value="pm">PM</option>
                            </select>[dd/mm/yyyy]                            
                        </td>
                        <td width="29%" class="textalign">Native District</td>
                        <td width="1%" class="mandatory"></td>
                        <td width="20%" colspan="4" class="textfieldalign" >
                            <!--                            <input type="text" class="textbox" name="nativeregion" id="nativeregion">-->
                            <select class="combobox" name="nativeregion" id="nativeregion" class="textfieldalign" ></select>
                        </td>
                    </tr>
                    <tr class="darkrow">
    ...
    <script type="text/javascript">
        ...
        function fillRegionCombo(map){
            ...
            dwr.util.removeAllOptions("nativeregion");
            dwr.util.addOptions("nativeregion",map.regionlist);
        ...
        function checkEPFno(){
            ...
            var epfno=document.getElementById('epfno').value;
            if(funtype=="add"){
                EmployeeMasterAction.getEmployeeEPFNo(epfno,validateEPFNo);
        ...
        function setEmployeeDetails(map){
            if(map.ERROR!=null && map.ERROR!=""){
                ...
                document.getElementById('positiondate').value=map.positiondate;
                document.getElementById('positiontime').value=map.positiontime;
                document.getElementById('nativeregion').value=map.nativeregion;
            }
