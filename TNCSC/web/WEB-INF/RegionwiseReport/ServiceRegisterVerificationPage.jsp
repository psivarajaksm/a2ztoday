    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onShow(){
                ...
                RegionwiseReportAction.getServiceRegisterDetailsGrid(syear, smonth,ayear, amonth, epfno, region, ShowScheduleGrid);
            }

            function ShowScheduleGrid(map){
                getBlanket('continueDIV');
                if(map!=null){
                    document.getElementById("showgrid").innerHTML = map.serviceGrid;
                }else{
            ...
            function onprintout(){                
                ...
                RegionwiseReportAction.getServiceRegisterDetailsReport(syear, smonth,ayear, amonth, epfno, region, EmployeePayBillPrintStatus);
            }            
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">SERVICE REGISTER VERIFICATION</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Service Register Verification Report</td>
                    </tr>
                    <tr class="darkrow">
