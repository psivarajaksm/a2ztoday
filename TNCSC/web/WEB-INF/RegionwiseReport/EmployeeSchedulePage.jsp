...
<%
            ...
            if (request.getSession().getAttribute("grouptype") != null) {
                grouptype = (String) request.getSession().getAttribute("grouptype");
            }
        ...
        <script type="text/javascript">
            ...
            function onShow(){
                ...
                if(smonth==null ||smonth.length==0 || syear==null || syear.length==0){
                    ...
                    RegionwiseReportAction.getScheduleGrid(syear, smonth,ayear, amonth, epfno, grouptype, region, reporttype, ShowScheduleGrid);
                }
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">RECOVERY DETAILS</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Recovery Details</td>
                    </tr>
                    <tr class="darkrow">
