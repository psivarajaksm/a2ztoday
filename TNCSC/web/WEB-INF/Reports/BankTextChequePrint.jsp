...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function addTextBox(){
                bno=prompt("Enter the No of Rows to be Add", "1");
                EmployeePayBillAction.addTextBox(bno, CallBackTextBoxAddition);
            }
            
            function CallBackTextBoxAddition(map){
                if(map.ERROR==null){
                    document.getElementById("txtboxdiv").innerHTML = map.txtbox;                    
                }else{
                    alert("Button ADD Error!");
                }
            ...
            function onprintout(){
                ...
                for(var i=0; i<bno; i++){
                    var stcheque = "startchequeno"+i;
                    var endcheque = "endchequeno"+i;
                    chequeno = chequeno + document.getElementById(stcheque).value+"##"+document.getElementById(endcheque).value;
                    chequeno += "@@";
                }
...
//                var chequeno = document.forms[0].chequeno.value;
                if(chequeno==null || chequeno==""){
                    ...
                    EmployeePayBillAction.EmployeeBankTextChequePrintOut(year, month, paymenttype, chequeno, EmployeePayBillPrintStatus);
                }
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Bank Text</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Bank Text</td>
                    </tr>
                    <tr class="lightrow">
                    ...
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Payment TYpe</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox" name="paymenttype" id="paymenttype">
                        ...
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <input type="button" class="submitbu" id="add1" value="Add Cheque No" onclick="addTextBox();">
                        </td>
<!--                        <td colspan="3" width="50%"></td>-->
                    </tr>
<!--                    <tr class="lightrow">
                        <td width="20%" class="textalign">Starting Cheque Number</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                                                        <input type="text" class="textbox" name="chequeno" id="chequeno" >
                            <input type="text" class="textbox" name="startchequeno" id="startchequeno" >
                        </td>
                        <td width="20%" class="textalign">Ending Cheque Number</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <input type="text" class="textbox" name="endchequeno" id="endchequeno">
                            <input type="button" class="submitbu" id="add1" value="Add" onclick="addTextBox();">
                        </td>
                    </tr>   -->
                    <tr class="darkrow">
                        <td colspan="6" width="100%">
                            <div id="txtboxdiv"></div>
                        </td>                        
                    </tr>                    
                    <tr class="lightrow">
