...
<html>
    <head>
        ...
        <script type="text/javascript">
            //            function onprintout(){
            //                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeLICSchedulePrintout";
            //                document.forms[0].submit();
            //            }
            function onprintout(reporttype){
                ...
                EmployeePayBillAction.EmployeeLICSchedulePrintout(year, month, reporttype, EmployeePayBillPrintStatus);
            }            
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">LIC Schedule Printout</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">LIC Schedule Printout</td>
                    </tr>
                    <tr class="darkrow">
                    ...
                    <tr class="lightrow">
                        <td colspan="6" align="center">
                            <input type="button" class="submitbu" id="printbut" value="Text Print" onclick="onprintout('TXT');">
                            <input type="button" class="submitbu" id="printbut1" value="Excel Print" onclick="onprintout('EXL');">
