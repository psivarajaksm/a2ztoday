...
<html>
    <head>
        ...
        <title>HBA Interest Schedule Details</title>
        ...
        <script type="text/javascript">
            //            function onprintout(){
            //                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeHBAInterestSchedulePrintout";
            ...
            function onprintout(){
                ...
                EmployeePayBillAction.EmployeeHBAInterestSchedulePrintout(year, month, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">HBA Interest Schedule Printout</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">HBA Interest Schedule Printout</td>
                    </tr>
                    <tr class="darkrow">
