...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                var grouptype = document.forms[0].grouptype.value;
                ...
                EmployeePayBillAction.EmployeeStorageLossPrintOut(syear, smonth, grouptype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">SCHEDULE</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Storage Loss Report</td>
                    </tr>
                    <tr class="darkrow">
                        ...
                        <td width="20%" class="textalign">Group Type</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign" >
                            <select class="combobox" name="grouptype" id="grouptype">
                                <option value="STLOSS">STORAGE LOSS</option>
                                <option value="LIC">LIC SCHEDULE</option>
                                <option value="PLI">PLI SCHEDULE</option>
                                <option value="HBA">HBA SCHEDULE</option>
                                <option value="HBAINT">HBA INT SCHEDULE</option>
                                <option value="VEHI">VEHICLE ADVANCE</option>
                            </select>
                        </td>
                    </tr>
                    <tr class="lightrow">
