...
//            function onprintout(){
//                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeSalaryAbstractPrintOut";
...
//            }
            function onprintout(){
                ...
                EmployeePayBillAction.EmployeeSalaryAbstractPrintOut(year, month, paymenttype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Salary Abstract</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Salary Abstract</td>
                    </tr>
                    <tr class="lightrow">
            ...
            <input type="hidden" name="paymenttype" id="paymenttype" value="all">
