...
<html>
    <head>
        ...
        <script type="text/javascript">
            //            function onprintout(){
            //                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeDeductionLedgerPrintOut";
            ...
            function onprintout(){
                ...
                EmployeePayBillAction.EmployeeDeductionLedgerPrintOut(year, month, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Deduction Ledger Printout</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Deduction Ledger PrintOut</td>
                    </tr>
                    <tr class="lightrow">
