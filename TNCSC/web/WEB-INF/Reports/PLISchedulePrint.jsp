...
//            function onprintout(){
//                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeePLISchedulePrintout";
...
//            }
            function onprintout(){
                ...
                EmployeePayBillAction.EmployeePLISchedulePrintout(year, month, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">PLI Schedule Printout</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">PLI Schedule Printout</td>
                    </tr>
                    <tr class="darkrow">
