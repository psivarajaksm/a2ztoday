<%-- 
    Document   : LPCPrint
    Created on : 17 Jun, 2015, 4:54:18 PM
    Author     : Onward
--%>
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Last Pay Certificate</td>
                    </tr>
                </table>
                <table width="70%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Last Pay Certificate</td>
                    </tr>
                    <tr class="darkrow">
    ...
    <script type="text/javascript">
        ...
        function onprintout(){
            ...
            if(epfno==""){
                ...
                var features = 'height=400,width=400,top=10,left=25,status=no,toolbar=0,location=0,menubar=0,titlebar=0,scrollbars=yes,modal=yes';
                var url="UserTypeAction.htm?method=LPCPrint&epfno="+epfno+"&month="+dmonthid+"&year="+dyearid+"&monthandyear="+monthandyear+"&billtype="+billtype;
                window.open(url, "Last Pay Certificate", features);
                return false;
            }
        }
    </script>
