    ...
    <head>
        ...
        <script type="text/javascript">
            function onprintout(type){
                ...
                document.getElementById("printbutcsv").disabled = true;
                var empcategory = document.forms[0].empcategory.value;
                EmployeePayBillAction.employeeDBFPrintout(type, empcategory, EmployeePayBillPrintStatus);
            }
            function EmployeePayBillPrintStatus(map){
                ...
                if(map.ERROR==null){
                    ...
                    document.getElementById("printbutcsv").disabled = false;
                }else{
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">EMPLOYEE DBF</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Employee DBF Print</td>
                    </tr>                    
                    <tr class="lightrow">
                        ...
                        <td colspan="2" align="center">
                            <input type="button" class="submitbu" id="printbut" value="Get DBF" onclick="onprintout('DBF');">
                        </td>
                        <td colspan="2" align="center">
                            <input type="button" class="submitbu" id="printbutcsv" value="Get CSV" onclick="onprintout('CSV');">
                        </td>
                    </tr>
                    <tr class="darkrow">
