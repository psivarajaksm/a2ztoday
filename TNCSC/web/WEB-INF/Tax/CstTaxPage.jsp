<%-- 
    Document   : CstTaxPage
    Created on : Apr 23, 2013, 12:45:13 PM
    Author     : root
--%>
...
<html>
    <head>
        ...
        <title>CST Tax Details Entry Form</title>
                    ...
                    buttons: {
                        "Ok": function() {
                            ...
                            if(monthyear==""){
                                ...
                                TaxAction.getCstTaxTableDetails(amonth+1,ayear, fillAccountingYearDetails);
                                $(this).dialog("close");
                            }
                ...
                $('#entryform').dialog({
                    ...
                    buttons: {
                        "save": function() {
                            ...
                            var csttaxid= document.getElementById('csttaxid').value;
...
//                            }
                                ...
                                TaxAction.saveCSTTax(csttaxid,month,year,companyname,commodityname,quantity,rate,amount,vat,vatamt,total,tinnumber,cstno, saveCSTTaxStatus);
//                                TaxAction.saveCSTTax(csttaxid,month,year,companyname,billdate,billno,commodityname,quantity,rate,amount,vat,vatamt,total, savePurchaseTaxStatus);
//                                $(this).dialog("close");
                            }
        ...
        <form method="post" name="myform">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="13" class="mainheader">CST Tax Entry</td>
                    </tr>
                    <tr class="darkrow">
                ...
                <div id="entryform" title="CST Tax Entry Form" >

                    <table table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr class="lightrow">
                            <td width="20%" class="textalign">Company Name</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text"  class="textbox" id="companyname"  name="companyname" size="20"/></td>
<!--                            <td width="25%"class="textfieldalign"><select class="combobox" name="companyname" id="companyname" onchange="getTinNumber(this.value);"></select></td>-->
                        ...
                        <tr class="darkrow">
                            <td width="20%" class="textalign">Tin No</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="textbox" id="tinnumber" onkeypress="isNumeric(this);"   name="tinnumber" size="20"/></td>
                        </tr>
                        <tr class="lightrow">
                            <td width="20%" class="textalign">CST No</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="textbox" id="cstno"  onkeypress="isNumeric(this);"  name="cstno" size="20"/></td>
                        </tr>
                        <tr class="darkrow">
                            <td width="20%" class="textalign">Commodity Name</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="textbox" id="commodityname"  name="commodityname" size="20"/></td>
<!--                            <td width="25%"class="textfieldalign"><select class="combobox" name="commodityname" id="commodityname" onchange="commodityChange();"  ></select></td>-->
                        ...
                        <tr class="lightrow">
                            ...
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="quantity" onkeypress="isNumeric(this);" onblur="caluclateAmount();" size="20"/></td>
                        </tr>
                        <tr class="darkrow">
                            <td width="20%" class="textalign">Rate</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="rate"  name="rate" onkeypress="isNumeric(this);"  onblur="caluclateAmount();" size="20"/></td>
                        </tr>
                        <tr class="lightrow">
                            <td width="20%" class="textalign">Amount</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="amount"  name="amount" onblur="checkFloat(this.id,'Amount');" onkeyup="caluclateVatAmount();" size="20"/></td>
                        </tr>

                        <tr class="darkrow">
                            <td width="20%" class="textalign">VAT %</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="vat"  name="vat"  onblur="checkFloat(this.id,'Vat %');" onkeyup="caluclateVatAmount();"  size="20"/></td>
                        </tr>

                        <tr class="lightrow">
                            <td width="20%" class="textalign">Vat Amount</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="vatamt"  name="vatamt"  onblur="checkFloat(this.id,'Vat Amount');" onkeyup="caluclateVatTotAmount();" readonly size="20"/></td>
                        </tr>
                        ...
                        <tr class="darkrow">
                            ...
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="total"  name="total" onblur="checkFloat(this.id,'Total');" readonly size="20"/></td>
                        </tr>
                    </table>
            ...
            <input type="hidden" name="csttaxid" id="csttaxid">
...
//      /  bodyonload();
        function bodyonload(){
            TaxAction.getCSTTaxTable(fillAccountingYearDetails);
...
//        }
        function fillAccountingYearDetails(map){
            ...
            document.getElementById("taxdetails").innerHTML=map.csttaxdetails;
        ...
        function showTaxEntryForm(){
            document.getElementById('csttaxid').value="";
        ...
        function setCstTaxId(id){
            document.getElementById('csttaxid').value=id;
            TaxAction.getCstTaxDetailsForModi(id, fillCSTTaxDetialForModi );
        }

        function fillCSTTaxDetialForModi(map){

            document.getElementById('csttaxid').value=map.csttaxid;
            document.getElementById('tinnumber').value=map.tinnumber;
            document.getElementById('cstno').value=map.cstno;
            document.getElementById('companyname').value=map.companyname;
            document.getElementById('commodityname').value=map.commodityname;
