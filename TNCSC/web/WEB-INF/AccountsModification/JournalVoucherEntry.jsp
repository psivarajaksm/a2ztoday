                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            if(regionsele=="0"){
                                ...
                                AccountsVoucherAction.getVoucherDetailsAllRegion(booksele,periodsele,voucherdatesele,'J',regionsele,fillVoucherDetailsForGivenDate);
                                $(this).dialog("close");
                            }
...
//                            document.getElementById("credit").innerHTML =dramt;
//                            document.getElementById("debit").innerHTML = cramt;   
                                ...
                                if($.trim(naaration)!=''){
                                    ...
                                    if(cramt.toFixed(2)-dramt.toFixed(2)!=0){
                                        ...
                                        if(sanctionedby==""){
                                            ...
                                            AccountsVoucherAction.ModifyVoucherDetails(period,booktype,voucherdate,'J',updationtype,voucherid,naaration,accountscode,accountsamount,accountsoption,partycode,partyamount,partypaymentmode,refno,bankcode,sanctionedby,fileno,partyalias,chequedate,regionsele, voucherSaveStatus);
                                        }
                                    }
                                }else{
