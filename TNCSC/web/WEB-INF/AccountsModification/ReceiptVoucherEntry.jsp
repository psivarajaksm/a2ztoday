                    ...
                    buttons: {
                        "Ok": function() {
                            ...
                            if(regionsele=="0"){
                                ...
                                AccountsVoucherAction.getVoucherDetailsAllRegion(booksele,periodsele,voucherdatesele,'R',regionsele,fillVoucherDetailsForGivenDate);
                                $(this).dialog("close");
                            }
                                    ...
                                    if(continuesavepart){
                                        if(netamt==recamt)
                                        {
                                            ...
                                            if(fileno==""){
                                                ...
                                                AccountsVoucherAction.ModifyVoucherDetails(period,booktype,voucherdate,'R',updationtype,voucherid,naaration,accountscode,accountsamount,accountsoption,partycode,partyamount,partypaymentmode,refno,bankcode,sanctionedby,fileno,partyalias,chequedate,regionsele, voucherSaveStatus);
                                            }
                                        }else{
