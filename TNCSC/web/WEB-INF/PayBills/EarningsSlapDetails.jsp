...
<html>
                ...
                $("#savebutton").click(function(){
                    ...
                    //                    }
                        ...
                        if (answer){
                            ...
                            EarningSlapDetailsAction.saveEarningsSlapDetails(earningstypes,effectdate,amtrangefrom,amtrangeto,slapamount
    ...
    <script type="text/javascript">
        bodyOnload();
        function bodyOnload(){
            EarningSlapDetailsAction.getLoadEarningsTypes(fillEarningsCombo);
        }
        ...
        function getDatasforModification(){
            ...
            var earningstypes=document.getElementById('earningstypes').value
             if(funtype=="0"){
                ...
                getBlanket('continueDIV');
                EarningSlapDetailsAction.getDatasForModify(earningstypes,fillDataforModify);
            }
        }
