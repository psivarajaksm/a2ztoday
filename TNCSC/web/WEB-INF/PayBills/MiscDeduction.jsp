<%-- 
    Document   : MiscDeduction
    Created on : 26 Feb, 2015, 12:52:34 PM
    Author     : Onward
    OldJSP     : MiscTransactionDeduction
--%>
...
<html>
                ...
                <div align="center" id="toolbar">
                    <table width="800px" border="0" cellspacing="0" cellpadding="0">
                        <tr class="darkrow">
                            ...
                            <td > <input id="excelupload" type="button" class="submitbu" value="excel upload" >&nbsp;&nbsp;&nbsp;</td>
                            <td > </td>
                        </tr>
                        <tr>
                            <td colspan="6">
    ...
    <script type="text/javascript">        
        bodyonload();
        function bodyonload(){
            EmployeePayBillAction.loadDeductionDetails("thirft",fillRegionCombo);
        }
        ...
        function fillLLPExcellSheet(map){
            ...
            table = llpdetails.table;            
            document.getElementById('displayGrid').innerHTML = table;
            fillLLPExcellSheetold(map);
        }
        function fillLLPExcellSheetold(map){
            var slno=0;
            var first=true;
