...
<html>
    <head>
        ...
        <script type="text/javascript">
                ...
                $('#manualform').dialog({
                    ...
                    buttons: {
                        "Update": function() {
                            ...
                            var daareardiffid= document.getElementById('daareardiffid').value;                           
                            ...
                            if(daasondate==""){
                                ...
                                DAIncrementArrearAction.DaManualFormUpdation(subpaybillid,dmonthid,dyearid,basicamount,perpayamt,gradepayamt,dueamt,drawnamt,arrearamt,epfamt,billtype, epfno, batchid, daareardiffid, updateDAManualStatus);
                                //                                $(this).dialog("close");
                            }
            ...
            function updateDAManualStatus(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    getBlanket('continueDIV');
                    alert(map.ERROR);
                    return false;
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="4" class="mainheader">DA Increment Arrear Re process Update</td>
                    </tr>
            ...
            <div id="manualform" title="DA Increment Arrear Manual Update Form" >
...
<!--                        <td width="25%" class="textfieldalign"><input type="text" id="newda"  name="newda" onblur="isPercentage(this.id,'perpayamt');" size="20"/></td>-->
            ...
            <input type="hidden" name="epfno" id="epfno" value="">
            <input type="hidden" name="batchid" id="batchid" value="">
            <input type="hidden" name="daareardiffid" id="daareardiffid" value="">
    ...
    <script type="text/javascript">
        ...
        function loadBatchwiseEmployees(batchid){
            getBlanket('continueDIV');
            DAIncrementArrearAction.getBatchEmployeeList(batchid,fillEmployeemap);
        }
        ...
        function modifyDADetails(epfno, batchid, daareardiffid){
            //alert("epfno = "+epfno+"\nbatchno ="+batchid+"\n daareardiffid = "+daareardiffid);            
            DAIncrementArrearAction.getDaIncrementArrearManualFormDetails(epfno, batchid, daareardiffid, showDAIncrementArrearManualFormDetails);
        }
        
        function showDAIncrementArrearManualFormDetails(map){
            if(map.ERROR!=null){
                alert(map.ERROR);
            }else{
                var damonth = map.damanualmonth-1;
                var dayear = map.damanualyear;
                $('#manualform').dialog('open');
                $('#daasondate').datepicker('setDate', new Date(dayear, damonth, 1));
                document.getElementById('epfno').value=map.epfno;
                document.getElementById('batchid').value=map.batchid;
                document.getElementById('daareardiffid').value=map.daareardiffid;
        ...
        /*function calculation(basic,perpay,gradepay,oldda,newda,billtype){
            ...
            arrearamt=parseFloat(due.toFixed(2)) - parseFloat(drawn.toFixed(2));
            epfamt=arrearamt*(parseFloat(12)/100);
