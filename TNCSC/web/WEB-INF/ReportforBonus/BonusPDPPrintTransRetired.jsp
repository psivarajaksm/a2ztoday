    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                BonusBillAction.RetiredInTransferEmployeeBonusPDPPrintOut(smonth, syear,amonth, ayear, pfno, category, section,  EmployeePayBillPrintStatus);
            }
                    ...
                    <tr class="lightrow">
                        ...
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox" name="category" id="category">
                                ...
                                <option value="T">In Transfer</option>
                            </select>
                        </td>
                    </tr>
<!--                    <tr class="darkrow">
