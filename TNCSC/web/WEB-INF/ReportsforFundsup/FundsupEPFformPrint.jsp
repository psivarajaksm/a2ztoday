    ...
    <head>
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                EmployeeFundSubAction.EmployeeFundsUpEPFFormPrintout(year, month, empcategory, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">EPF Form Text</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">EPF Form Text</td>
                    </tr>
                    <tr class="darkrow">
