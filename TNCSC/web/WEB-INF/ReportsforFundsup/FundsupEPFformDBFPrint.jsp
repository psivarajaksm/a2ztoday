...
//            function onprintout(){
//                document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeEPFFormPrintout";
...
//            }
            function onprintout(){
                ...
                EmployeeFundSubAction.EmployeeFundsUpEPFFormDBFPrintout(year, month, empcategory, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Supplementary EPF Form Printout</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Supplementary EPF Form Printout</td>
                    </tr>
                    <tr class="darkrow">
                    ...
                    <tr class="lightrow">
                        <td width="20%" class="textalign">Category</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
