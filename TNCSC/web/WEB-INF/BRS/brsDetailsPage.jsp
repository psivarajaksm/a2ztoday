<%-- 
    Document   : brsDetailsPage
    Created on : 25 Mar, 2014, 3:14:46 PM
...
<html>
    <head>
        ...
        <title>BRS File Upload Details</title>
        ...
        <script type="text/javascript">
            ...
            function ShowBRSDetails(){
                ...
                if(accountbook==0){
                    ...
                    BRSAction.getBrsReportDetails(smonth+1,syear,accountbook,accountingperiod, displayBrsDetails );
                }
            }
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">BRS File Upload Details</td>
                    </tr>
                </table>
                <table width="70%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">BRS File Upload Details</td>
                    </tr>   
                    <tr class="lightrow">
