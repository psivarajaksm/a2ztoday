...
<html>
    <head>
        ...
        <title>Employee Provident Fund Loan Application Working Sheet</title>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $("#workingsheet").click(function(){
                    ...
                    if(chkarray==""){
                        ...
                        getBlanket('continueDIV');
                        EPFLoanAction.getWorkingSheet(chkarray,showStatusWorkingsheet);
            ...
            function showStatusWorkingsheet(map){
                getBlanket('continueDIV');
        ...
        <form method="post" name="myform">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Loan Working Sheet</td>
                    </tr>
                </table>
