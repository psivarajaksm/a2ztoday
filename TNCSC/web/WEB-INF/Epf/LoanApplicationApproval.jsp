...
<html>
    <head>
        ...
        <title>Employee Provident Fund Loan Application Approval</title>
            ...
            $(function() {
                ...
                $("#showbutton").click(function(){
                    ...
                    if(monthyear==""){
                        ...
                        EPFLoanAction.getEpfLoanForApproval(amonth+1,ayear,fillLoanReceiptDetails);
                        //                        $(this).dialog("close");
                    }
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            if(rejectreason==""){
                                ...
                                getBlanket('continueDIV');
                                EPFTransactionAction.modifyEmployeeEPF(chkarray,rejectreason,modifyEmployeeEPFStatus);
                                $(this).dialog("close");
                            }
                        },
                        "Cancel": function() {
        ...
        <form method="post" name="myform">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Loan Approval</td>
                    </tr>
                </table>
                ...
                <div id="loanrejectionform" title="EPF Loan Rejection Form" >
                    <table table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr class="lightrow">
                            <td width="20%" class="textalign">Reject Reason</td>
                            <td width="5%" class="mandatory">*</td>
                            <td width="25%"class="textfieldalign"><textarea class="textareabox" rows="2" cols="140" id="rejectreason" name="rejectreason" ></textarea>
                            </td>
                        </tr>
