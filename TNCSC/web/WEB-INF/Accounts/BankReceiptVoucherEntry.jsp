...
<html>
    <head>
        ...
        <title>Bank Receipt Voucher Entry</title>
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            if(booksele=="0"){
                                ...
                                alert("Please Select the Bank Receipt Voucher Date");
                                return false;
                            }else{
...
//            }
            ...
            function showVoucherEntryForm(){
                ...
                if(booksele=="0"){
                    ...
                    alert("Please Select the Bank Receipt Date");
                    return false;
                }else if(periodsele==""){
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="13" class="mainheader">Bank Receipt Entry</td>
                    </tr>
                    <tr class="darkrow">
                        ...
                        <tr>
                            <td  width="50%" valign="top" >
                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <div  id="partyGrid" class="dataTable" style="width:980px;height:130px; overflow: auto" ></div>
                                        </td>
    ...
    <script type="text/javascript">
        ...
        function fillVoucherDetailsForModi(map){ 
            ...
            document.getElementById('sanctionedby').value=map.sanctionedby;
