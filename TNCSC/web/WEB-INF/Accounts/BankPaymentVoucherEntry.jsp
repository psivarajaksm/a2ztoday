                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            if(booksele=="0"){
                                ...
                                alert("Please Select the Bank Payment Date");
                                return false;
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            if(continuesave){
                                if($.trim(naaration)!=''){
                                    //                                    if( (payamt-adjamt) != 0){
                                    //                                        alert("Payment and Adjustment Values Should tally!");
                                    //                                    }else{
                                    if(continuesavepart){
...
//            }
            ...
            function voucherSaveStatus(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    ...
                    if(map!=null){
                        AccountsReportsAction.BankPrintout(map.voucherno, map.voucherdate, map.booktype, EmployeePayBillPrintStatus);
                    }
                }
            }
        ...
        <form method="post" name="myform">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="13" class="mainheader">Bank Entries</td>
                    </tr>
                    <tr class="darkrow">
                ...
                <div id="voucherentryform" title="Bank Entries Form" >
                    <table  width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
    ...
    <script type="text/javascript">
        ...
        bodyonload();
        function bodyonload(){          
            AccountsVoucherAction.getVoucherEmptyTable('2',fillVoucherDetails);   
            AccountsVoucherAction.getAccountsCodeListPartyDetails(fillEarningsDeductionsExcellSheet); 
        }
