...
//                var journalno;
//                if(Obj.vno.length == 0){
//                    alert("Please Select the Journal No");
//                    return false;
//                }else{
//                    for (i = 0; i < Obj.vno.length; i++){
//                        if (Obj.vno[i].checked){
//                            journalno = Obj.vno[i].value
//                        }
//                    }
//                    var param=trim(journalno).split('&');
//                    var vno = param[0];
//                    var date = param[1];
...
//                    AccountsReportsAction.JournalPrintout(vno, date, booktype, EmployeePayBillPrintStatus);
//                }
//            }
            ...
            function onShow(){
                ...
                var journalno = document.forms[0].journalno.value;
                document.getElementById('journalgrid').innerHTML="";
                AccountsReportsAction.getJournalDetails(startingdate, enddate,cashbooktype,journalno, LoadJournalGrid);
            }

            function LoadJournalGrid(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    alert(map.ERROR);
                    return false;
                } else {
                    document.getElementById('journalgrid').innerHTML=map.journalgrid;
                }
            }
        </script>
    </head>
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">JOURNAL</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Journal Report</td>
                    </tr>
                    <tr class="darkrow">
...
<!--                            <select class="combobox" name="type" id="type">
                                <option value="1">CERAL I</option>
                                <option value="2">CERAL II</option>
                                <option value="3">NON CERAL</option>
                            </select>-->
                        </td>
                        <td width="20%" class="textalign">Journal No</td>
                        <td width="5%" class="mandatory"></td>
                        <td width="25%"class="textfieldalign" >
                            <input type="text" class="textbox" name="journalno" id="journalno">
