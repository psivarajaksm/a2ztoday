...
//                }
//                if(Obj.vno.length == 0){
//                    alert("Please Select the Bank No");
//                    return false;
//                }else{
//                    for (i = 0; i < Obj.vno.length; i++){
//                        if (Obj.vno[i].checked){
//                            bankno = Obj.vno[i].value
//                        }
//                    }
//                    var param=trim(bankno).split('&');
//                    var vno = param[0];
//                    var date = param[1];
...
//                    AccountsReportsAction.BankPrintout(vno, date, booktype, EmployeePayBillPrintStatus);
//                }
//            }
            ...
            function onShow(){
                ...
                AccountsReportsAction.getBankDetails(startingdate, enddate,cashbooktype,bankno, LoadJournalGrid);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">BANK</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Bank Report</td>
                    </tr>
                    <tr class="darkrow">
...
<!--                            <select class="combobox" name="type" id="type">
                        ...
                        <td width="20%" class="textalign">Bank No</td>
                        <td width="5%" class="mandatory"></td>
                        <td width="25%"class="textfieldalign" >
                            <input type="text" class="textbox" name="bankno" id="bankno">
