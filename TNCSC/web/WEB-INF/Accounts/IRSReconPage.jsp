...
<html>
    <head>
        ...
        <title>Inter Region Recon Page </title>
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            AccountsVoucherAction.getIRSLedgerDetails( periodsele, ledgersele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);                            
                            $(this).dialog("close");
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                AccountsReportsAction.LedgerPrintOut(ledgersele, periodsele,voucherdatefrom,voucherdateto,"1", EmployeePayBillPrintStatus);
            }
    ...
    <body>
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="darkrow">                       
                        ...
                        <td width="15%" class="textfieldalign" ><input type="text" id="ledgerdisp" name="ledgerdisp"  size="20" readonly /></td>
                ...
                <div id="voucherdetails" style="display:none;height:400px;overflow:auto;"></div>
                <input type="button" class="submitbu" id="printbut" value="Show Adj" onclick="showAdjustmentDraft();">
            ...
            <div id="adjform" title="Adj Form" >
                <div id="adjdetails" style="display:none;height:400px;overflow:auto;"></div>
            </div>  
            <div id="footer">
    ...
    <script type="text/javascript">    
        bodyonload();
        function bodyonload(){          
            AccountsVoucherAction.getIRSLedgerEmptyTable(fillLedgerDetails);               
        }  
        ...
        function fillVoucherDetailsForGivenDate(map){            
            document.getElementById('voucherdetails').style.display="block";
            document.getElementById("voucherdetails").innerHTML=map.voucherdetails;   
            document.getElementById('ledgerdisp').value=map.ledgerdisp;                       
            ...
            oTable = $('#vouchertable1').dataTable({
                "bJQueryUI": true,
                "sScrollY":"275px",
                "bSort": false,
                "bFilter": false,
            ...
            oTable = $('#vouchertable2').dataTable({
                "bJQueryUI": true,
                "sScrollY":"275px",
                "bSort": false,
                "bFilter": false,
        ...
        function showAdjustmentDraft(){
           
            var chkarray="";            
            var chkboxes=document.getElementsByName("sourcevoucher");
            for (i=0;i<chkboxes.length;i++){
                if (chkboxes[i].checked==true){
                    if(chkarray.length>0){
                        chkarray=chkarray+"sai*-*sri*&*sai*-*sri"+chkboxes[i].value;
                    }else{
            ...
            var chkarray1="";            
            var chkboxes=document.getElementsByName("destvoucher");
            for (i=0;i<chkboxes.length;i++){
                if (chkboxes[i].checked==true){
                    if(chkarray1.length>0){
                        chkarray1=chkarray1+"sai*-*sri*&*sai*-*sri"+chkboxes[i].value;
                    }else{
                        chkarray1=chkarray1+chkboxes[i].value;                        
                    }
                }
            }
            AccountsVoucherAction.AdjustmentDetails(chkarray, chkarray1, fillAdjustmentDetails);                    
            
        }
        function fillAdjustmentDetails(map){         
            document.getElementById('adjdetails').style.display="block";
            document.getElementById("adjdetails").innerHTML=map.adjustmentdetails; 
            oTable = $('#adjtable1').dataTable({
                "bJQueryUI": true,
                "sScrollY":"275px",
                "bSort": false,
                "bFilter": false,
        ...
        function createAdjustment(){
            ...
            AccountsVoucherAction.applyAdjustmentDetails(chkarray, chkarray1, fillAdjustmentDetailsA);            
        }
        
        function fillAdjustmentDetailsA(){                 
            var ledgersele = document.getElementById('ledger').value;  
            var periodsele = document.getElementById('periodsele').value;  
            var voucherdatefrom = document.getElementById('voucherdatefrom').value;  
            var voucherdateto = document.getElementById('voucherdateto').value;                              
            AccountsVoucherAction.getIRSLedgerDetails( periodsele, ledgersele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);                            
            $('#adjform').dialog('close');
        }
