...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                var percentage = document.forms[0].percentage.value;
                ...
                AccountsReportsAction.PurchaseVatBreakupPrintOut(smonth, syear, percentage, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">PURCHASE HO</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Purchase Vat Breakup</td>
                    </tr>
                    <tr class="darkrow">
                        ...
                        <td width="20%" class="textalign">Vat Percentage</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign" >
