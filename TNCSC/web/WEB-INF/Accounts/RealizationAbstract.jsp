        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Realization Abstract Report</td>
                    </tr>
                </table>
                <table width="70%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Realization Abstract Report</td>
                    </tr>
                    <tr class="darkrow">
                    ...
                    <tr class="lightrow">
                        <td width="20%" class="textalign">Realization Type</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                        ...
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox" name="accbook" id="accbook"></select>
                        </td>
                    </tr>
                    <tr class="darkrow">
    ...
    <script type="text/javascript">
        ...
        function onprintout(){
            ...
            if(startingdate==""){
                ...
                alert("Please Select the Realization type");
                ...
                var url="AccountsReportsAction.htm?method=RealizationAbstractPrint&fromDate="+startingdate+"&toDate="+enddate+"&ctype="+ctype+"&accbook="+accbook;
                window.open(url, "Realization Abstract Report", "width=1000,height=800");
                //                getBlanket('continueDIV');
                return false;
            }
        }
