    ...
    <head>
        ...
        <script type="text/javascript">
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            AccountsVoucherAction.getConsolidatedTrailBalanceDetails( periodsele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);
            ...
            function trialPrint(){
                var voucherdatefrom = document.getElementById('voucherdatefrom').value;
                var voucherdateto = document.getElementById('voucherdateto').value;
                var url="AccountsReportsAction.htm?method=consolidatedTrialBalancePrint&fromDate="+voucherdatefrom+"&toDate="+voucherdateto;                    
