...
<html>
    <head>
        ...
        <script src="dwr/interface/BankEntryAction.js"></script>
        ...
        <script type="text/javascript">
            ...
            function onUploadfile(){
                ...
                if(fileName.length==0){
                    ...
                    document.forms[0].action = "BankEntryAction.do?method=uploadReconciliationFile";
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Bank Reconciliation Upload</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Upload Reconciliation File</td>
                    </tr>                    
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Bank Name</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox" name="bankname" id="bankname"></select>
                        </td>
                        <td width="20%" class="textalign">Month & Year</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <input type="text" id="recondate" name="recondate"  size="20" />
                        </td>
                    </tr>
                    <tr class="lightrow">
                        <td width="20%" class="textalign">Upload File</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
    ...
    <script type="text/javascript">
        bodyonload();
        function bodyonload(){          
            BankEntryAction.getBankDetails(loadbankdialogbox);               
        }
        function loadbankdialogbox(map){
            if(map.banklist!=null){
                dwr.util.removeAllOptions("bankname");
                dwr.util.addOptions("bankname", map.banklist);
            }
        }
    </script>
</html>