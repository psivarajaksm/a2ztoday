    ...
    <head>
        ...
        <script type="text/javascript">
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            AccountsVoucherAction.getTrailBalanceDetailsByRegion( periodsele, voucherdatefrom, voucherdateto,selectedRegion, fillVoucherDetailsForGivenDate);
                            //                            AccountsVoucherAction.getTrailBalanceDetails(booksele, periodsele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);
                            $(this).dialog("close");
            ...
            function trialPrint(){
                ...
                var voucherdateto = document.getElementById('voucherdateto').value;
                var selectedRegion = document.getElementById('region').value;
                var url="AccountsReportsAction.htm?method=trialBalancePrintByRegion&fromDate="+voucherdatefrom+"&toDate="+voucherdateto+"&selectedRegion="+selectedRegion;                    
                window.open(url, "Trial Balance Report", "width=1000,height=800");
                return false;
            }
           
//            function trialBalanceCsvPrepare(){   
//                var periodsele = document.getElementById('periodsele').value;  
//                var voucherdatefrom = document.getElementById('voucherdatefrom').value;  
//                var voucherdateto = document.getElementById('voucherdateto').value;  
//                AccountsReportsAction.trialBalanceCsvPrepare(periodsele, voucherdatefrom, voucherdateto, trialBalanceCsvDownload);
...
//                //                EmployeePayBillAction.EmployeePayBillPrintOut(epfno, sectionname, year, month, paymenttype, trialBalanceCsvDownload);
//            }
            
            function trialBalanceCsvDownload(map){
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" colspan="15" >Trail Balance</td>
                    </tr>
                    <tr class="darkrow">
