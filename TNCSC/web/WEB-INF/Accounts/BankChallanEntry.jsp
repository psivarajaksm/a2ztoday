...
<html>
            ...
            $(function() {
                ...
                $('#voucherentryform').dialog({
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            AccountsVoucherAction.addToChallanDetails("chdd",recId,challanno,challandate,fillChallanDetails);
                            $(this).dialog("close"); 
                        },
                        "Cancel": function() {
                            $(this).dialog("close");
                ...
                $('#challanformdetails').dialog({
                    ...
                    buttons: {                        
                        "Cancel": function() {
                            var challandate = document.getElementById('challandate').value;  
                            AccountsVoucherAction.getChallanDetails("chdd",challandate,fillChallanDetails);
                            $(this).dialog("close");
                        }
                    }
                });
                ...
                $('#challanform').dialog({
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            var chkboxes=document.getElementsByName("receipt");
                            ...
                            AccountsVoucherAction.createBankChallan("chdd",chkarray,challandate,bank,remarks,periodcode,fillChallanDetails);    
                            $(this).dialog("close"); 
                        },
                        "Cancel": function() {
                            $(this).dialog("close");
    ...
    <script type="text/javascript">       
        bodyonload();
        function bodyonload(){
            AccountsVoucherAction.getBankChallanEmptyTable("chdd",fillChallanDetails);           
        }        
        ...
        function showChallanDetails(challanid){
            AccountsVoucherAction.loadChallanDetails("chdd",challanid,showChallanDetailsForm); 
        ...
        function removeFromChallan(recptid){
            AccountsVoucherAction.removeFromChallan("chdd",recptid,showChallanDetailsForm);             
        }
        
        function printChallanDetails(challanid){
            AccountsReportsAction.BankChallanPrintOut(challanid, "cheque", EmployeePayBillPrintStatus);
        }
        ...
        function checkAll(a)
        {
            var receiptAll=document.getElementsByName("receiptall");
            var recLen=document.getElementsByName("receipt");
