    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(Obj){          
                ...
                AccountsReportsAction.getVoucherReceiptDetailDetailsPrintOut(startingdate, enddate, VoucherReceiptDetailDetailsPrintOut);                  
            }

            function VoucherReceiptDetailDetailsPrintOut(map){
            ...
            function onShow(){               
                ...
                AccountsReportsAction.getVoucherReceiptDetailDetails(startingdate, enddate, LoadVoucherGrid);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">ACCOUNTS VOUCHER RECEIPT DASHBOARD</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Voucher Report</td>
                    </tr>
                    <tr class="darkrow">
                        ...
                        <td width="25%"class="textfieldalign" >
                            ...
                            <input type="button" class="submitbu" id="search" value="Show" onclick="onShow();">
                        </td>                        
                    </tr>
