    ...
    <head>
        ...
        <script type="text/javascript">
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            AccountsVoucherAction.getTrailBalanceDetails( periodsele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);
            ...
            function trialPrint(){
                var voucherdatefrom = document.getElementById('voucherdatefrom').value;
                var voucherdateto = document.getElementById('voucherdateto').value;
                var url="AccountsReportsAction.htm?method=trialBalancePrint&fromDate="+voucherdatefrom+"&toDate="+voucherdateto;                    
