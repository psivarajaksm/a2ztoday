<%-- 
    Document   : AdminRemittanceEntry
    Created on : Aug 29, 2013, 10:32:45 AM
    Author     : root
--%>
            ...
            $(function() {
                ...
                $("#showbutton").click(function(){
                    ...
                    if(voucherdatefrom==""){
                        ...
                        CashierEntryAction.getRemittanceEntryDetails(voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);
                    }
