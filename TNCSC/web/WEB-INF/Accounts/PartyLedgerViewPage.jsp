...
//                            var booksele= document.getElementById('book').value;
                            ...
                            AccountsVoucherGroupAction.getLedgerDetailsMap( periodsele, ledgersele, voucherdatefrom, voucherdateto,"1", fillVoucherDetailsForGivenDate);
...
<!--                        <tr class="darkrow">
    ...
    <script type="text/javascript">    
        bodyonload();
        function bodyonload(){          
            AccountsVoucherAction.getPartyLedgerEmptyTable(fillLedgerDetails);               
        }  
