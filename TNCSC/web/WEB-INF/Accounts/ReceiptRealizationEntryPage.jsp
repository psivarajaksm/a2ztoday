...
<html>
    <head>
        ...
        <title>Receipt Realization Entry</title>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                //                            CashierEntryAction.getReceiptDetails( periodsele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);
                //                            $(this).dialog("close");
                //                        },
                //
                //                        "Cancel": function() {
                ...
                $('#voucherentryform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {  
                            ...
                            CashierEntryAction.saveReceiptRealizationDate(recpayid, realizationdate, fillVoucherDetailsForGivenDate);                            
                            $(this).dialog("close");
                        },
                        "Cancel": function() {                            
                            $(this).dialog("close");
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Receipt Realization Entry</td>
                    </tr>
                    <br>
                    <td width="100%" class="mainheader">Receipt Realization Entry</td>
                </table>
                <!--                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                    <tr class="darkrow">
    ...
    <script type="text/javascript">              
        ...
        function bodyonload(){
            getBlanket('continueDIV');
            CashierEntryAction.getReceiptDetails(fillVoucherDetailsForGivenDate);
...
//                "aLengthMenu": [[50, 100,150, -1], [ 50, 100,150, "All"]]
    ...
    <script type="text/javascript">
        function onprintout(){
            var realizationstatus = "false";
            if(document.forms[0].isrealized.checked){
                realizationstatus = "true";
            }
            //                alert("periodsele = "+periodsele+"\nvoucherdatefrom="+voucherdatefrom+"\nvoucherdateto="+voucherdateto+"\nbook="+book);
            ...
            AccountsReportsAction.ReceiptRealizationPrintOut(realizationstatus, EmployeePayBillPrintStatus);
        }
