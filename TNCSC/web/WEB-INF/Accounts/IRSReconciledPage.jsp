    ...
    <head>
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                   
                            ...
                            AccountsVoucherAction.getIRSReconciledLedgerDetails( periodsele, ledgersele, voucherdatefrom, voucherdateto, fillVoucherDetailsForGivenDate);                            
                            $(this).dialog("close");
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                AccountsVoucherAction.getIRSReconciledLedgerDetailsExcellWrite( periodsele, ledgersele, voucherdatefrom, voucherdateto, EmployeePayBillPrintStatus);                            
            }
...
//                    document.getElementById("printbut").disabled = false;
    ...
    <script type="text/javascript">    
        ...
        function fillVoucherDetailsForGivenDate(map){            
            ...
            oTable = $('#irsreporttable').dataTable({
                "bJQueryUI": true,
                "sScrollY":"275px",
                "bSort": false,
                "bFilter": false,
