        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                if(startingdate.length==0 || enddate.length==0){
                    ...
                    AccountsReportsAction.cashBookRegionPrintout(startingdate, enddate, cashbookname, cashbooktype,selectedRegion, EmployeePayBillPrintStatus);
                }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Cash Book Report
