    ...
    <head>
                ...
                $('#accbookdateform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {                                                               
                            ...
                            CashierEntryAction.getPaymentDetails( periodsele, voucherdatefrom, voucherdateto,book, fillVoucherDetailsForGivenDate);                            
                            $(this).dialog("close");                            
                        },
                ...
                $('#voucherentryform').dialog({  
                    ...
                    buttons: {
                        "Ok": function() {  
                            ...
                            var voucherdateto = document.getElementById('voucherdateto').value;  
                            var book = document.getElementById('book').value;  
                            CashierEntryAction.savePaymentRealizationDate(recpayid, realizationdate, periodsele, voucherdatefrom, voucherdateto,book, fillVoucherDetailsForGivenDate);                            
                            $(this).dialog("close");
                        },
                        "Cancel": function() {                            
                            $(this).dialog("close");
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                AccountsReportsAction.PaymentRealizationPrintOut(periodsele,voucherdatefrom,voucherdateto,book, realizationstatus, EmployeePayBillPrintStatus);
            }
