                    ...
                    buttons: {
                        "Ok": function() {
                            ...
                            if(booksele=="0"){
                                ...
                                AccountsVoucherAction.getVoucherDetails(booksele,periodsele,voucherdatesele,'P',fillVoucherDetailsForGivenDate);
                                $(this).dialog("close");
                            }
                        },
...
//                            document.getElementById("netbalance").innerHTML =parseFloat(payamt)-parseFloat(adjamt)
                            ...
                            netamt=(Math.round(netamt*100)/100).toFixed(2);
                            ...
                            if(continuesave){
                                if($.trim(naaration)!=''){
                                    if( (payamt-adjamt) < 0){
                                        ...
                                        if(continuesavepart){
                                            if(netamt==netamount)
//                                            if(parseFloat(netamt)==parseFloat(payamt-adjamt))
                                            {
                                                if(sanctionedby==""){
