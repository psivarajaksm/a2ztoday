        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                if(smonth==null ||smonth.length==0 || syear==null || syear.length==0){
                    ...
                    AccountsReportsAction.PurchaseAbstractPrintOut(smonth, syear,EmployeePayBillPrintStatus);
                }
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Purchase</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Purchase Abstract Report</td>
                    </tr>
                    <tr class="darkrow">
