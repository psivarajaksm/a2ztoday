        ...
        <script type="text/javascript">
                ...
                $('#accbookdateform').dialog({
                    ...
                    buttons: {
                        "Ok": function() {
                            ...
                            var paybilltype = document.getElementById('paybilltype').value;
                            if(booksele=="0"){
                                ...
                                AccountsVoucherAction.checkPayrollVoucherDetails(year, month, paybilltype,function(smap){
                                    if(smap.CHECK!=null){
                                        $('#accbookdateform').dialog("close");
                                        alert(smap.CHECK);
                                        return false;
                                    }else{
                                        AccountsVoucherAction.getPaybillVoucherDetails(booksele,periodsele,voucherdatesele,'P', month, year, paybilltype, fillVoucherDetailsForGivenDate);
                                        $('#accbookdateform').dialog("close");
                                    }
                                });                           
                ...
                $('#voucherentryform').dialog({
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            for (var i = 0; i < accountsData.length; i++){
                                ...
                                if(accountsData[i][2]=='Payment'){
                                    if($.isNumeric(accountsData[i][1])){
                                        payamt=parseFloat(payamt)+parseFloat(accountsData[i][1]);
                                    }
                                }
                                if(accountsData[i][2]=='Adjustment'){
                                    if($.isNumeric(accountsData[i][1])){
                                        adjamt=parseFloat(adjamt)+parseFloat(accountsData[i][1]);
                                    }
                                }
                            ...
                            document.getElementById("payment").innerHTML =parseFloat(payamt);
                            document.getElementById("adjustment").innerHTML = parseFloat(adjamt);
                            document.getElementById("netbalance").innerHTML =parseFloat(payamt)-parseFloat(adjamt)
                            var netamt=0;
                                        ...
                                        if(continuesavepart){
                                            if(netamt==(payamt-adjamt))
                                            {
                                                if(sanctionedby==""){
                                                    ...
                                                    AccountsVoucherAction.saveVoucherDetails(period,booktype,voucherdate,'P',updationtype,voucherid,naaration,accountscode,accountsamount,accountsoption,partycode,partyamount,partypaymentmode,refno,bankcode,sanctionedby,fileno,partyalias,chequedate, voucherSaveStatus);
                                                }
            ...
            function voucherSaveStatus(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    ...
                    if(map!=null){
                        var voucherno = map.voucherno;
                        var voucherDetailsID = map.voucherDetailsID;
                        var voucherdate = map.voucherdate;
                        var booktype = map.booktype;
                        
                        var month = document.getElementById('month').value;
                        var year = document.getElementById('year').value;
                        var paybilltype = document.getElementById('paybilltype').value;
                            
                        AccountsVoucherAction.SavePayrollVoucherDetails(year,month,paybilltype,voucherno,function(smap){
                            if(smap.ERROR!=null && smap.ERROR!=""){
                                getBlanket('continueDIV');
                                alert(smap.ERROR);
                                return false;
                            }else{
            ...
            <div id="content">
                ...
                <div id="accbookdateform" title="Voucher Date & Type Selection Form" >
                    <table  width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="darkrow">
                            <td width="48%" class="textalign">Paybill Month</td>
                            <td width="2%" class="mandatory">*</td>
                            <td width="50%" class="textfieldalign" >
                        ...
                        <tr class="lightrow">
                            <td width="48%" class="textalign">Paybill Year</td>
                            <td width="2%" class="mandatory"></td>
                            <td width="50"class="textfieldalign"><%=request.getSession().getAttribute("year")%></td>
                        </tr>
                        <tr class="darkrow">
                            <td width="48%" class="textalign">Voucher Type</td>
                            <td width="2%" class="mandatory"></td>
                            <td width="50"class="textfieldalign">
    ...
    <script type="text/javascript">
        ...
        function fillEarningsDeductionsExcellSheet(map){
            ...
            partycontainer.handsontable({
                ...
                //                rowHeaders: false,
                colHeaders: true,
                colHeaders: ["RECEIVER NAME","ALIAS NAME", "AMOUNT","PAYMENT MODE","CHEQUE/DD NUMBER","BANK NAME","CHEQUE DATE(DD-MM-YYYY)"],
