    ...
    <head>
            ...
            $(function() {
                ...
                $("#showbutton").click(function(){
                    ...
                    if(ledgersele=="0"){
                        ...
                        AccountsVoucherGroupAction.getConsolidatedLedgerDetailsMap( periodsele, ledgersele, voucherdatefrom, voucherdateto, reporttype, fillVoucherDetailsForGivenDate);                        
                    }
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                AccountsReportsAction.consolidatedLedgerPrintOut(ledgersele, periodsele,voucherdatefrom,voucherdateto,reporttype, EmployeePayBillPrintStatus);
            }
