        ...
        <script type="text/javascript">
            ...
            function onprintout(Obj){
                ...
                if(Obj.vno.length==undefined){
                    if (Obj.vno.checked){
                        receiptno = Obj.vno.value
                        var param=trim(receiptno).split('&');
                        var vno = param[0];
                        var date = param[1];
                        ...
                        AccountsReportsAction.ReceiptPrintout(vno, date, booktype, EmployeePayBillPrintStatus);
                    }
                }else{
                    if(Obj.vno.length == 0){
            ...
            function onShow(){
                ...
                AccountsReportsAction.getReceiptDetails(startingdate, enddate,cashbooktype,receiptno, LoadReceiptGrid);
            }

            function LoadReceiptGrid(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    alert(map.ERROR);
                    return false;
                } else {
                    document.getElementById('receiptgrid').innerHTML=map.receiptgrid;
                }
            }
        </script>
    </head>
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">RECEIPT</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Receipt Report</td>
                    </tr>
                    <tr class="darkrow">
                    ...
                    <tr class="lightrow">
                        ...
                        <td width="20%" class="textalign">Receipt No</td>
                        <td width="5%" class="mandatory"></td>
                        <td width="25%"class="textfieldalign" >
                            <input type="text" class="textbox" name="receiptno" id="receiptno">
