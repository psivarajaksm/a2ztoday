<%-- 
    Document   : CashBookChangePage
    Created on : Apr 8, 2013, 1:22:13 PM
    Author     : root
--%>
...
//                    var voucherids=document.getElementById('voucherids').value;
//                    if(acctype=="0"){
...
//                        return false;
//                    }else if(accbook=="0"){
//                        alert("Please Select the Change Account Book");
//                        document.getElementById('accbook').focus();
//                        return false;
//                    }else if(voucherids==""){
//                        alert("Please Select the Check box to Change Account Book");
//                        return false;
//                    }else{
//                        getBlanket('continueDIV');
//                        CashierEntryAction.saveAccountBookChange(accbook,voucherids,accountdate,saveAccountBookDetails);
//
//                    }
//                });
            });
            function saveAccountBook(){
                var acctype=document.getElementById('acctype').value;
                    ...
                    var chkarray="";
                    var chkboxes=document.getElementsByName('accbookchangeName');                    
                    ...
                    if(acctype=="0"){
                        ...
                        alert("Please Select the atleast one Check box to Change Account Book");
                        return false;
                    }else{
                        getBlanket('continueDIV');
                        CashierEntryAction.saveAccountBookChange(accbook,chkarray,accountdate,saveAccountBookDetails);

                    }

            }

            function saveAccountBookDetails(map){
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td width="100%" colspan="7" align="center" class="headerdata">Account Book Change</td>
                    </tr>
                    <tr>
                        <td colspan="7" class="mainheader">A/C Book Change</td>
                    </tr>
                    <tr class="darkrow">
    ...
    <script type="text/javascript">
        ...
        function loadEntries(obj){
            ...
            if(acctype=="0"){
                ...
                CashierEntryAction.getVoucherAccountsDetails(acctype,accountdate,accbook,fillVoucherAccountsDetails)
            }
        ...
        function addChangeAccountBookDetails(voucherid){            
            var voucherids=document.getElementById('voucherids').value;
            voucherids=voucherids+voucherid+",";
            document.getElementById('voucherids').value=voucherids;
        }
