<%-- 
    Document   : ReceiptAccHeadwiseAbstract
    Created on : May 14, 2013, 4:10:02 PM
    Author     : root
--%>
...
<html>
    <head>
        ...
        <title>Receipt Acc.Head Wise Abstract Report</title>
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Receipt Acc.Head Wise Abstract Report</td>
                    </tr>
                </table>
                <table width="70%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Receipt Acc.Head Wise Abstract Report</td>
                    </tr>
                    <tr class="darkrow">
...
//                getBlanket('continueDIV');
                var url="AccountsReportsAction.htm?method=receiptHeadWiseAbstractPrint&fromDate="+startingdate+"&toDate="+enddate;
                window.open(url, "Receipt Acc.Head Wise Abstract", "width=1000,height=800");
//                getBlanket('continueDIV');
                return false;
           }
    </script>
