...
<html>
    <head>
        ...
        <title>Budget Probable Entry</title>
        ...
        <script type="text/javascript">
                ...
                $('#budgetdetailsform').dialog({
                    ...
                    buttons: {
                        "Save": function() {
                            ...
                            BudgetAction.saveBudgetDetails(budgetdetailsid,ledgerid,ledgername,fistactual,secondactual,thirdactual,average,currentbudgetestimate,actualfirsthalf,probablesecondhalf,currentrevisedestimate,nextyearbudgetestimate,currentrevisedestimateho,nextyearbudgetestimateho,saveBudgetDetailsStatus);
                            $(this).dialog("close");
            ...
            function saveBudgetDetailsStatus(map){
                if(map.ERROR!=null && map.ERROR!=""){
                    ...
                    BudgetAction.getBudgetForRevision(region,startyear,endyear, displayBudgetDetailsAfterSave );
                }
            }
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="100%" align="center" class="headerdata">Budget Probable Entry</td>
                                </tr>
                            </table>
                            <table width="80%" align="center" class="tableBorder2" border="0" cellpadding="0" cellspacing="0">
                                <!--                                            <tr>
                                                                                <td colspan="9" class="mainheader">Budget Revision Entry</td>
                                                                            </tr>-->
                                <!--                                            <tr class="lightrow">
            ...
            <div id="budgetdetailsform" title="Budget Details" >
                <table table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="darkrow">
                        ...
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox"  id="firstactual" name="firstactual"  onblur="calculateAverage();"  onkeypress="isNumeric(this);" size="20" /></td>
                    </tr>

                    <tr class="lightrow">
                        <td width="20%" class="textalign"><label id='second'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox"  id="secondactual" name="secondactual" onblur="calculateAverage();"  onkeypress="isNumeric(this);" size="20" /></td>
                    </tr>

                    <tr class="darkrow">
                        <td width="20%" class="textalign"><label id='third'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox"  id="thirdactual" name="thirdactual" onblur="calculateAverage();"  onkeypress="isNumeric(this);" size="20" /></td>
                    </tr>

                    <tr class="lightrow">
                        <td width="20%" class="textalign">Average</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="average" name="average"  size="20" readonly /></td>
                    </tr>

                    <tr class="darkrow">
                        <td width="20%" class="textalign">Budget Estimate <label id='current'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="currentyearbudgetestimate" name="currentyearbudgetestimate" onkeypress="isNumeric(this);"  size="20" /></td>
                    </tr>

                    <tr class="lightrow">
                        <td width="20%" class="textalign">Actuals Upto September</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="actualfirsthalf" name="actualfirsthalf" onblur="calculateRevisedEstimate();" onkeypress="isNumeric(this);"   size="20" /></td>
                    </tr>
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Probable October to March</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="probablesecondhalf" name="probablesecondhalf" onblur="calculateRevisedEstimate();" onkeypress="isNumeric(this);" size="20" /></td>
                    </tr>
                    <tr class="lightrow">
                        <td width="20%" class="textalign">Revised Estimate <label id='current1'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="currentrevisedestimate" name="currentrevisedestimate"  size="20"  onkeypress="isNumeric(this);"  /></td>
                    </tr>
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Budget Estimate <label id='next'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="nextyearbudgetestimate" name="nextyearbudgetestimate"  size="20"  onkeypress="isNumeric(this);"  /></td>
                    </tr>
                    <tr class="lightrow">
                        <td width="20%" class="textalign">Revised Estimate <label id='current2'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="currentrevisedestimateho" name="currentrevisedestimateho"  size="20" readonly /></td>
                    </tr>
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Budget Estimate<label id='next1'>dude</label></td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign"><input type="text" class="amounttextbox" id="nextyearbudgetestimateho" name="nextyearbudgetestimateho"  size="20" readonly /></td>
                    </tr>
                </table>
            </div>
    ...
    <script type="text/javascript">
        ...
        function displayBudgetForRevision(){
            ...
            if(startyear==""){
                ...
                getBlanket('continueDIV');
                BudgetAction.getBudgetForRevision(region,startyear,endyear, displayBudgetDetails );
            }
        }
        ...
        function downloadbudget(startyear, endyear ){
            document.forms[0].action = "BudgetAction.do?method=downLoadBudgetDetails";
