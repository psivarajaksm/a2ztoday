    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                document.forms[0].action = "EpfAction.htm?method=epfFileUploadSave";
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $('#newloanform').dialog({
                    ...
                    buttons: {
                        "Save / Update": function() {                           
                            ...
                            EpfAction.EpfDetailsInsert(EpfDetailsInsertStatus);
                            $(this).dialog("close");                          
                        },
                        "Cancel": function() {
                            $(this).dialog("close");
                ...
                EpfAction.getUploadedDetails(fillUploadedDetails);
            });

            function EpfDetailsInsertStatus(map){
                if(map.Error!=null){
                    getBlanket('continueDIV');
                    alert(map.Error) ;
                }
    ...
    <body topmargin="0" marginheight="0" leftmargin="0" marginleft="0" valign="center" >
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div id="content">
                        ...
                        <tr>
                            <td>
                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="100%" align="center" class="headerdata">Epf Upload</td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td width="49%" align="center" valign="top">
                                            <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td colspan="4" class="mainheader">Epf Upload</td>
                                                </tr>
                                                <tr class="lightrow">
                ...
                <div id="newloanform" title="EPf Details" >
                    <% if (request.getSession().getAttribute("epfUploadDetails") != null) {
                            Map epfmap = (Map) request.getSession().getAttribute("epfUploadDetails");
                            Grid = (String) epfmap.get("epfGrid");
                    %>
                    <%=Grid%>
                    <script>onloadgrid();</script>
                    <%
                        }
                    %>
                </div>
