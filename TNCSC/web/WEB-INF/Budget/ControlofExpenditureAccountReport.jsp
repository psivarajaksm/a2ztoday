...
//                var ledgerid = document.forms[0].ledgerid.value;
                ...
                BudgetAction.ControlofExpenditureAccountReportPrintOut(ledgerid, smonth, syear, accountingperiod, EmployeePayBillPrintStatus);
            }
                                ...
                                <tr>
                                    <td width="49%" align="center" valign="top">
                                        <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="4" class="mainheader"><bean:message key="ControlofExpenditureAccountReport" /></td>
                                            </tr>                                            
                                            <tr class="lightrow">
