...
<%
            ...
            if((request.getAttribute("validButtonFlag")!=null))
            validButtonFlag = (String) request.getAttribute("validButtonFlag");
                    ...
                    <tr>
                        <td>
                                    ...
                                    <td width="49%" align="center" valign="top">
                                        <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr class="darkrow">
                                                ...
                                                <td width="5%" class="mandatory">*</td>
                                                <td width="65%" colspan="2" class="textfieldalign" >
                                                    <input type="text" class="textbox" name="uploadmonth" id="uploadmonth" readonly>
                                                    <input type="button" class="submitbu" name="save" id="save" value="Existing Data" onclick="getOldRecords()">
                                                </td>
                                            </tr>
                            ...
                            <script type="text/javascript">
                                bodyonload();
                                function bodyonload(){
                                    FileUploadAction.displayTextFileDatas(fillDisplayTextFileDatas);
                                }
