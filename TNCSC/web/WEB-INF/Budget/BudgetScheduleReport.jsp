...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                var ledgerid = document.forms[0].ledgerid.value;
...
//                alert("ledgerid "+ledgerid);
                BudgetAction.BudgetScheduleReportPrintOut(ledgerid, startyear, endyear, EmployeePayBillPrintStatus);
            }
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="100%" align="center" class="headerdata">Budget Schedule</td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td width="49%" align="center" valign="top">
                                        <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="4" class="mainheader">Budget Schedule</td>
                                            </tr>
                                            <tr class="lightrow">
                                                <td width="30%" class="textalign">Ledger Type</td>
