<%-- 
    Document   : BudgetFMAReportPage
    Created on : 24 Mar, 2014, 11:32:52 AM
    Author     : sivaraja_p
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                BudgetAction.BudgetFMAReportPrintOut(region, startyear, endyear, EmployeePayBillPrintStatus);
            }
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="100%" align="center" class="headerdata">Budget FMA Report</td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td width="49%" align="center" valign="top">
                                        <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="4" class="mainheader">Budget Report</td>
                                            </tr>
                                            <tr class="lightrow">
