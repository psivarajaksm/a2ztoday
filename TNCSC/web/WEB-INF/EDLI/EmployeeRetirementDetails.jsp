...
<html>
                ...
                $("#showbutton").click(function(){
                    ...
                    var tyear=eval(toyear)-1;
                     if(fromyear==""){
                        ...
                        EDLIAction.getRetirementDetails(fromyear,toyear,fillUploadedDetails);
                    }
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div id="content">
                ...
                <table width="100%" align="center"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" colspan="7"  align="center" class="headerdata">Employee Retirement Details</td>
                    </tr>
                    <tr class="lightrow">
            ...
            <div id="empdetailsform" title="Retirement Details" >
    ...
    <script type="text/javascript">
        ...
        function fillUploadedDetails(map){
            ...
            oTable = $('#empretirementtable').dataTable({
                "bJQueryUI": true,
                "sScrollY":"225px",
                "bSort": false,
                "bFilter": true,
...
//                "aLengthMenu": [[20, 40, 100, -1], [20, 50, 100, "All"]]
        ...
        function showRegionMonthwiseRetirementEmployees(month,regionid){
            var fromyear=document.getElementById('fromdate').value;
            if(fromyear==""){
                alert("Please select the Financial Start Year");
                document.getElementById('fromdate').focus();
                ...
                getBlanket('continueDIV');
                EDLIAction.getRegionMonthwiseRetirementEmployees(month,regionid,fromyear,fillFormDetails);
            }
...
//                "aLengthMenu": [[20, 40, 100, -1], [20, 50, 100, "All"]]
        ...
        function getALLRegionMonthwiseRetirementEmployees(month){
            var fromyear=document.getElementById('fromdate').value;
            if(fromyear==""){
                alert("Please select the Financial Start Year");
                document.getElementById('fromdate').focus();
                ...
                getBlanket('continueDIV');
                EDLIAction.getALLRegionMonthwiseRetirementEmployees(month,fromyear,fillFormDetails);
            }

        }
        function getRegionAllMonthsRetirementEmployees(regionid){
            var fromyear=document.getElementById('fromdate').value;
            var toyear=document.getElementById('todate').value;
            if(fromyear==""){
                alert("Please select the Financial Start Year");
                ...
                getBlanket('continueDIV');
                EDLIAction.getRegionAllMonthsRetirementEmployees(fromyear,regionid,toyear,fillFormDetails);
            }

        }
        function getAllRegionRetirementEmployees(){
            var fromyear=document.getElementById('fromdate').value;
            var toyear=document.getElementById('todate').value;
            if(fromyear==""){
                alert("Please select the Financial Start Year");
                ...
                getBlanket('continueDIV');
                EDLIAction.getAllRegionRetirementEmployees(fromyear,toyear,fillFormDetails);
            }
