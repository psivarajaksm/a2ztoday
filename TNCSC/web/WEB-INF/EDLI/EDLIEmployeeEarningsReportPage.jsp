<%-- 
    Document   : EDLIEmployeeEarningsReportPage
    Created on : 22 Jul, 2015, 11:22:07 AM
    Author     : Onward
--%>
...
<html>
    <head>
        ...
        <title>EDLI Employee Earnings Report</title>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                if(category=='0'){
                    ...
                    EDLIAction.edliEmployeeEarningsDeductionPrintOut(syear, smonth,ayear, amonth, region, category, reporttype,edliEmployeeReportStatus);
                }
            }
                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="100%" align="center" class="headerdata">EDLI Employee Earnings Report</td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td width="100%" align="center" valign="top">
                                        <table width="100%" align="center" class="tableBorder" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="6" class="mainheader">EDLI Employee Earnings Report</td>
                                            </tr>
                                            <tr class="darkrow">
                                            ...
                                            <tr class="lightrow">
                                                ...
                                                <td width="25%"class="textfieldalign" >
                                                    <select id="reporttype" name="reporttype">
                                                        <option value="0">Select</option>
                                                        <option value="1">Earnings Detail</option>
                                                        <option value="2">Deduction Detail</option>
                                                        <option value="3">Earnings & Deduction</option>
                                                    </select>
                                                </td>
                                            </tr>                                           
                                            <tr class="darkrow">
