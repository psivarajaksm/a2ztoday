    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $('#payslipenddate').datepicker({
                    ...
                    onClose: function(dateText, inst) {
                        ...
                        $(this).datepicker('setDate', new Date(ayear, 1));
                    }
                });
            });
            ...
            function onprintout(){
                ...
                if(syear==null || syear.length==0){
                ...
                }else if(ayear==null ||ayear.length==0){
                    ...
                    IncomeTaxAction.IncomeTaxTentativeParticularsPrintOut(syear, ayear, pfno, reporttype, section, EmployeePayBillPrintStatus);
                }
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Tentative Particulars</td>
                    </tr>
                    <tr class="darkrow">
                    ...
                    <tr class="lightrow">
                        ...
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox" name="reporttype" id="reporttype">
                                ...
                                <option value="3">Abstract Excel</option>
                            </select>
                        </td>
                    </tr>
                    <tr class="darkrow">
