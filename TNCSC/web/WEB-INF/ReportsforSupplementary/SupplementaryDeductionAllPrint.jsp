...
//            function onprintout(){
//                    document.forms[0].action = "EmployeePayBillAction.do?method=EmployeeDeductionAllPrintOut";
//                    document.forms[0].submit();
//            }
            function onprintout(){
                var deductionid = document.forms[0].deductionid.value;
                ...
                SupplementaryBillAction.EmployeeSupplementaryDeductionAllPrintOut(year, month, deductionid, reporttype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Supplementary Schedule All</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Supplementary Schedule All</td>
                    </tr>
                    <tr class="lightrow">
                    ...
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Deduction</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <%=(String)request.getSession(false).getAttribute("deductionlist")%>
                        </td>
