    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                var atype = document.forms[0].atype.value;
                ...
                SupplementaryBillAction.EmployeeSupplementaryDAAcquitanceCashPrintOut(dabatch,atype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">DA Acquittance Cash</td>
                    </tr>
                    <tr class="lightrow">
                    ...
                    <tr class="darkrow">
                        ...
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <select class="combobox"  name="atype" id="atype">
