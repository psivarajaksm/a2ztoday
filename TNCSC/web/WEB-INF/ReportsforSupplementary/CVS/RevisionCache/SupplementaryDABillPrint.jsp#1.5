    ...
    <head>
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                var epfno = "";
                epfno = document.forms[0].epfno.value;
                ...
                SupplementaryBillAction.EmployeeSupplementaryDABillPrintOut(dabatch, epfno, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">DA Arrear Slip</td>
                    </tr>
                    <tr class="lightrow">
