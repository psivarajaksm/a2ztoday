...
//            }
            function onprintout(){
                ...
                SupplementaryBillAction.EmployeeSupplementaryLICSchedulePrintout(year, month, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Supplementary LIC Schedule</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Supplementary LIC Schedule</td>
                    </tr>
                    <tr class="darkrow">
