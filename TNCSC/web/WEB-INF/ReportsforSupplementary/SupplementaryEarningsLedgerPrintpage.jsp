<%-- 
    Document   : SupplementaryEarningsLedgerPrintpage
    Created on : 6 Apr, 2015, 12:02:14 PM
    Author     : Onward
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                var ledgertype = document.forms[0].ledgertype.value;
                ...
                SupplementaryBillAction.EmployeeSupplementaryEarningsLedgerDetails(asondate, ledgertype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">Supplementary Earnings Ledger page</td>
                    </tr>
                    <tr class="lightrow">
                        ...
                        <td width="20%" class="textalign">Ledger Type</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
                            <select id="ledgertype">
                                <option value="1">Earnings Ledger</option>
                                <option value="2">Deductions Ledger</option>
                            </select>
                        </td>
                    </tr>
                    <tr class="darkrow">
