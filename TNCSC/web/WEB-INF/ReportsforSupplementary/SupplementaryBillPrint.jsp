...
//            }
            function onprintout(){
                ...
                SupplementaryBillAction.EmployeeSupplementaryBillPrintOut(epfno, asondate, billtype, EmployeePayBillPrintStatus);
            }
            ...
            <div id="content">
                <table width="100%" align="center" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="lightrow">
                        ...
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%"class="textfieldalign" ><input type="text" class="textbox" name="asondate" id="asondate" readonly></td>
                    </tr>
