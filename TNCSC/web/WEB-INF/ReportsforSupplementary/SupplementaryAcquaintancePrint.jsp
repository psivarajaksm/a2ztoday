    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onprintout(){
                ...
                SupplementaryBillAction.employeeSupplementaryAcquaintancePrintOut(asondate, billtype, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">Supplementary Acquaintance</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">

                    <tr>
                        <td colspan="6" class="mainheader">Supplementary Acquaintance</td>
                    </tr>
                    <tr class="lightrow">
