    ...
    <head>
        ...
        <script type="text/javascript">
            function onprintout(){
                ...
                SupplementaryBillAction.EmployeeSupplementaryDAAcquitanceChequePrintOut(dabatch,chequeno, EmployeePayBillPrintStatus);
            }
        ...
        <form method="post">
            ...
            <div id="content">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="100%" align="center" class="headerdata">DA Acquittance Cheque</td>
                    </tr>
                </table>
                <table width="100%" align="center" class="tableBorder2" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td colspan="6" class="mainheader">DA Cheque Payment</td>
                    </tr>
                    <tr class="lightrow">
                    ...
                    <tr class="darkrow">
                        <td width="20%" class="textalign">Cheque Number</td>
                        <td width="5%" class="mandatory">*</td>
                        <td width="25%" class="textfieldalign" >
